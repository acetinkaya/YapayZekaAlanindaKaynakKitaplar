...
| **Yapay Öğrenme** |  Yapay Öğrenme kavramını ve öreklerini bilgisayarların örnek veri ya da geçmiş deneyimi kullanarak bir ölçüte göre başarımını hesaplamasını anlatan bir referans kaynaktır. | 978-605-4238-49-1 | Boğaziçi Üniversitesi Yayınevi | 
| **Bulanık Mantık ve Python Uygulamaları** | YZ Bulanık Mantık konusunda python programlama dili ile uygulamali bir kaynak. |  978-605-4827-98-5 | IGU Yayınları	| [ Link ](https://www.amazon.com.tr/Bulan%C4%B1k-Mant%C4%B1k-ve-Python-Uygulamalar%C4%B1/dp/6054827987) | 7 |
...
7. Öğr. Gör. Ali ÇETİNKAYA, "Bulanık Mantık ve Python Uygulamaları". İstanbul Gelişim Üniversitesi Yayınları, 2023.
